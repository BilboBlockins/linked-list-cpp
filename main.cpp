...
Brett Hiebert
Linked List Test
Description: This is a test program for the LinkedList and Node classes. 
It imports different data types into the linked list data structure and tests various LinkedList member functions.
09/29/2018
*/
...
//DATETIME - Simple check that the data type works.
	...
	DateTime d3(9, 3, 2018); // create some datetime instances
	DateTime d4(9, 4, 2018);
	DateTime d5(9, 5, 2018);
